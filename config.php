<?php
# Đơn vị hỗ trợ xây dựng phần mềm NA Sơftware
...
define('USERNAME','cltxhme_cltxlam');
define('PASSWORD','cltxhme_cltxlam');
define('DATABASE','cltxhme_cltxlam');
...
$tele_token = $MinhChien->site('token_tele');
$tele_idchat = $MinhChien->site('id_chat');
...
if(check_string(isset($_SESSION['username']))) { 
    ...
    if(!$getUser) {
        ...
        die('Tài Khoản Của Bạn Đã Vị Khóa Vì Vi Phạm Điều Khoản Của Chúng Tôi !Liên hệ admin để được mở ban');
        exit;
    }
